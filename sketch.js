...
var ground, invisibleGround, groundImage, colored_groundImg;
...
function preload() {
  ...
  colored_groundImg = loadImage("ground.png");
...
function draw() {
  ...
  if (gameState === PLAY) {
    ...
    //when mouse is pressed over restart button, game resets
...
//actions to be performed when restart button is pressed 
function reset() {
  gameState = PLAY;
  restart.visible = false;
  gameOver.visible = false;
  //destroys the clouds and obstacles
  obstaclesGroup.destroyEach();
  cloudsGroup.destroyEach();
  //change the animation back to trex running
